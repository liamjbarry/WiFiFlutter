...
// const String ssid = "Fingoti";
// const String pass = "Duck5lipp3rs";

const String ssid = 'FINGOTI-S9B3S9D8N8';
const String pass = 'fingoftheinternet';
...
class _FlutterWifiIoTState extends State<FlutterWifiIoT> {
  Future<bool> connect() async {
    try {
      ...
      print("wifi applied $isConnected");
      var currentSSID = await WiFiForIoTPlugin.currentSSID();
      print(currentSSID);
      return isConnected;
